<div class="modal" tabindex="-1" role="dialog" id="createPermissionModal">
            ...
            <form id="createPermissionForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <select class="form-control resource" name="model" id="resource">
                    ...
                    <div class="form-group">
                        ...
                        @foreach (Cruds::all() as $key => $value)
                            <div class="form-check">
                                <input class="form-check-input permission" type="checkbox" name="permission[]" id="permission-{{ $key }}" value="{{ $key }}" multiple="multiple">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary btn-permission" id="storePermission">Save</button>
                </div>
            </form>
